...
export interface Employee { id:string; fullName:string; phone?:string|null; telegramUsername?:string|null; pickupPointIds:string[]; paymentType:PaymentType; rateKopecks:number; monthlyNormDays:number; status:'ACTIVE'|'ARCHIVED' }
export interface SalaryRule { id:string; employeeId:string; paymentType:PaymentType; rateKopecks:number; effectiveFrom:string; monthlyNormDays:number|null }
export interface Shift { id:string; employeeId:string; pickupPointId:string; startsAt:string; endsAt:string; actualStartsAt?:string|null; actualEndsAt?:string|null; status:ShiftStatus }
...
export interface PointSalaryDefault { id:string; pickupPointId:string; paymentType:PaymentType; rateKopecks:number; monthlyNormDays:number }
